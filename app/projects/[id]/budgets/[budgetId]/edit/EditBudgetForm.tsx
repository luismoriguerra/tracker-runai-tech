...
export default function EditBudgetForm({ projectId, budgetId }: EditBudgetFormProps) {
    ...
    const fetchBudget = async () => {
      try {
        ...
        setFormData({
          ...
          amount: budget.estimated_amount.toString(),
        });
      } catch (error) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      router.push(`/projects/${projectId}/budgets/${budgetId}`);
      router.refresh();
    } catch (error) {
